namespace Loupedeck.HapticsPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.HapticsPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.HapticsPlugin.Resources.Resource.txt`.
